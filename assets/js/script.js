$(document).ready(function () {
    $("form").submit(function (event) {
        ...
        var numer = $("#heroInput").val();
        if (733 > numer > 0) {
            console.log("Héroe Encontrado");
        }
        else {
            alert("Debes ingresar un número que sea mayor a 1 y menor a 733")
        }


        $.ajax({
            type: "GET",
            url: "https://superheroapi.com/api.php/10224398063072253/" + valueInput,
